...
router.add_api_route('/image/{pk}/', handler.create_product_image, methods=['post'])
router.add_api_route('/image/{pk}/', handler.update_product_image, methods=['patch'])
router.add_api_route('/image/{pk}/', handler.delete_product_image, methods=['delete'])
